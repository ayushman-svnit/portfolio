...
export default function Navbar() {
  ...
  const scrollTo = (e, href) => {
    e.preventDefault();
    setOpen(false); // Close mobile menu immediately
    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          >
            <div
              className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white font-black text-sm"
              style={{ boxShadow: '0 0 20px rgba(99,102,241,0.4)' }}
            >
              A
            </div>
            <span className="font-bold text-sm text-slate-300 group-hover:text-white transition-colors hidden sm:inline">
            ...
            >
              ...
              <div className="p-6 flex flex-col gap-2">
                ...
                <motion.a
                  ...
                  className="flex items-center gap-2 px-4 py-3 rounded-lg text-sm font-medium text-slate-300 bg-white/[0.05] border border-white/10 hover:border-primary/40 hover:text-white transition-all mt-4"
                >
                  <Download size={16} />
                  Download Resume
                </motion.a>
